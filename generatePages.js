...
const createPage = (name, title, icon, content) => {
    ...
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex items-center gap-4 border-b border-white/5 pb-6">
        ...
        <div>
          ...
          <p className="text-textSecondary">Manage and analyze your ${title.toLowerCase()} metrics.</p>
        </div>
      </div>
...
`;
  fs.writeFileSync(path.join('src', 'pages', name + '.jsx'), code);
};

createPage('CitizenOverview', 'Citizen Overview', 'Users', 'Demographics');
createPage('BillSimplifier', 'Bill Simplifier', 'FileText', 'Legislation');
createPage('FraudWatch', 'Fraud Watch', 'ShieldAlert', 'Anomaly');
createPage('AIChat', 'AI Assistant', 'MessageSquare', 'Conversational');
createPage('SentimentAnalyzer', 'Sentiment Analyzer', 'BarChart3', 'Public Opinion');
createPage('ImpactSimulator', 'Impact Simulator', 'TrendingUp', 'Predictive');
createPage('Roadmap', 'Civic Roadmap', 'Map', 'Timeline');
createPage('Archive', 'Archive', 'Archive', 'Historical');
createPage('Settings', 'Settings', 'Settings', 'Preferences');
createPage('Support', 'Support & Help', 'HelpCircle', 'Support Ticket');
